...
def run_multiple_simulations(year, month, day):
    ...
    di_stokes = False            #depth-integrated
    di_stokes_biomass = True     #depth-integrated including a dependency of depth-extent on biomass 
    ...
    output_file_name = "FINAL/SIM2_sat_LA_{year_start:04d}_{month_start:02d}_{day_start:02d}_0.5_extent.zarr"
