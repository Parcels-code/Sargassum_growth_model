...
def run_multiple_simulations(year, month, day):
    ...
    di_stokes_wave_damping = True  #depth-integrated including a wave damping
    ...
    output_file_name = "FINAL/SIM2_sat_LA_{year_start:04d}_{month_start:02d}_{day_start:02d}_0.5_damping.zarr"
