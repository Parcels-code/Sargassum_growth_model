...
output_file_name = "Simulations_part2/SIM_26sept_largegrid_may_no_transport.zarr"
...
release_lon1 = np.linspace(-57, -48, 9*12+1)  # 12 points in longitude
release_lat1 = np.linspace(7, 12, 5*12+1)     # 12 points in latitude

release_lon2 = np.linspace(-47.9166666666666666, -39, 9*12)
release_lat2 = np.linspace(3, 8, 5*12+1)

release_lon3 = np.linspace(-38.9166666666666666, -30, 9*12)
release_lat3 = np.linspace(-1, 4, 5*12+1)
