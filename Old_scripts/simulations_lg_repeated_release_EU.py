...
def run_multiple_simulations(year, month, day):
    ...
    output_file_name = "FINAL/SIM1_LG_EU_{year_start:04d}_{month_start:02d}.zarr"
    ...
    if add_wind:
        ...
        ds = xr.open_mfdataset('/storage/shared/oceanparcels/input_data/ERA5/reanalysis-era5-single-level_wind10m_{year:04d}*.nc')
    ...
    GRIDMASK5 = xr.open_dataarray('/storage/shared/oceanparcels/output_data/data_Elena/LANDMASK_small_depth.nc') 
    GRIDMASK5 = GRIDMASK5.rename({'x': 'lon', 'y': 'lat'})

    grid_lon, grid_lat = gi.grid_creation(
        lon_min=-75, lon_max=-10,
        lat_min=-4, lat_max=24,
        nlon=6, nlat=6,
        landmask=GRIDMASK5
    )
    ...
    pset = parcels.ParticleSet.from_list(
        ...
        pclass = SargassumParticle,
            ...
            lon = grid_lon,            #vector of release longitudes
            lat = grid_lat,            #vector of release latitudes
