...
output_file_name = "Simulations_test_may_14.zarr"
...
nparticles = 12   #how many particles will be advected

pset = parcels.ParticleSet.from_list(
     fieldset=fieldset,  # the fields on which the particles are advected
     pclass=parcels.JITParticle,  # the type of particles (JITParticle or ScipyParticle)
     lon=[-40, -40, -40, -43, -43, -43 , -46, -46, -46, - 48, -48, -48], # a vector of release longitudes
     lat=[2,  5,  8, 2, 5,  8, 2, 5,  8, 2, 5,  8],                # a vector of release latitudes
